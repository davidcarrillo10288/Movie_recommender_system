## Función para determinar la similitud de coseno de películas - Top 10

def similitud_coseno(test, df_vectorizer, cosine):
  ...
  sim_scores = list(enumerate(cosine[index_title]))
